...
student_lrs=(30 30 30 30 30 30 30 30)
lr_gammas=(0.25 0.25 0.25 0.25 0.25 0.25 0.25 0.25)
student_steps_list=(1 1 1 1 1 1 1 1)
student_epochs_list=(5 10 15 20 45 50 55 60)
...
for i in ${!student_epochs_list[@]};do
    ...
    log_folder_name=logs/unequal_restart
    ...
    nohup python -u unequal_restart.py \
